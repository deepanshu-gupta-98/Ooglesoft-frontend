                ...
                <article className="postbox__item format-image transition-3">
                  <div className="postbox__content">
                    ...
                    <div className="postbox__text">
                      <p>Celebso is a platform where you can promote your project and startup by genuine influencer and you can show your project publicly here. In this, many investors are also connected and if they interested in your project then they will invest also. Celebso is a ultimate platform for new Entrepreneurs Brands and Influencers to connect, collaborate, and grow together.</p>
